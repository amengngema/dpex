...
<section id="about" class="main style-primary">
    <div class="container">
...
<section id="tools">
    <div class="container">
        <div class="row">
                ...
                <div id="track-and-trace">
                    ...
                    <div class="form-group clearfix">
                        <div class="iput-group">
                            <textarea class="form-control" placeholder="Enter DPEX Worldwide Air Waybill / Tracking Number (up to 10 entries, one per line)"></textarea>
            ...
            <div class="col-md-6">
                <div id="online-tools">
                    <h1 class="title">Online Tools</h1>
                    <ul>
                        <li>
